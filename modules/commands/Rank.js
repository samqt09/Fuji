...
let random = Math.floor(Math.random() * 7) + 1;
		...
		if (existsSync(__dirname + `/noprefix/rankup/rank.gif`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/noprefix/rankup/rank.gif`), mentions: [{ tag: name, id: senderID }] };
...
module.exports.languages = {
	...
	"en": {
		...
		"levelup": "『 {name} 』Ang iyong ka-kyutan sa gc ay nasa level {level} na!!",
	}
}
