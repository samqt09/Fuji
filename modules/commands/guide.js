...
=== [ 𝗔𝗗𝗠𝗜𝗡 𝗕𝗢𝗧 ] ===
  ...
  ❯ 𝗥𝗣 𝗡𝗔𝗠𝗘 : (⁠ᗒ⁠ᗩ⁠ᗕ⁠)
  ❯ 𝗛𝗘𝗜𝗚𝗛𝗧 : 5'9
  ❯ 𝗗𝗔𝗧𝗘 𝗢𝗙 𝗕𝗜𝗥𝗧𝗛 : secret 
  ❯ 𝗭𝗢𝗗𝗜𝗔𝗖 : 𝐂𝐚𝐧𝐜𝐞𝐫 
  ❯ 𝗪𝗘𝗜𝗚𝗛𝗧 : secret 
  ❯ 𝗙𝗕 𝗔𝗖𝗖𝗢𝗨𝗡𝗧 : https://www.facebook.com/sam.ramos
...
responseType: "stream"
        ...
        case "3": {
          const axios = require('axios');
       api.unsendMessage(handleReply.messageID);
    return api.sendMessage({body: `𝐀𝐝𝐦𝐢𝐧 𝐒𝐨𝐜𝐢𝐚𝐥 𝐌𝐞𝐝𝐢𝐚 :\n—Sam Ramos: https://www.facebook.com/sam.ramos.39566905?mibextid=ZbWKwL\n—: https://www.facebook.com/sam.ramos.`, attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://api.zeidbot.site/images/phongcanhimg')).data.data,
method: "GET",
responseType: "stream"
})).data
