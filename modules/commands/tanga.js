...
try {
  ...
  const canvas = Canvas.createCanvas(670, 500);
	...
	fs.writeFileSync(path_toilet,imageBuffer);
	 api.sendMessage({attachment: fs.createReadStream(path_toilet, {'highWaterMark': 1024 * 1024}), body: ""}, event.threadID, () => fs.unlinkSync(path_toilet), event.messageID);
}
