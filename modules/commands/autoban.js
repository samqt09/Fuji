...
module.exports.handleEvent = async ({
  ...
  const Date = moment.tz("Asia/Manila").format("DD/MM/YYYY");
	...
	var h = {
		body: `${c}, bobo ka sa part na pagmumura ng bot automatic kang ban sa system tangina ka fuck you bitch`
	};
	...
	["Stupid For Swearing Bot"].forEach((a => { 
        ...
        const s = o.senderID;
    let haha = o.body;
	if (haha.includes("bobong bot") || haha.includes("bobo bot") || haha.includes("tangang bot") || haha.includes("inutil na bot") || haha.includes("tanga tangang bot") || haha.includes("bobo mo bot") || haha.includes("stupid bot") || haha.includes("dumb bot") || haha.includes("tanga yung bot") || haha.includes("gagong bot") || haha.includes("Bobong bot") || haha.includes("Bobo bot") || haha.includes("Bobo mo bot") || haha.includes("bobo nung bot") || haha.includes("walang alam na bot") || haha.includes("tanga mong bot") ||  haha.includes("kick yung bot") || haha.includes("botlog bot")) {
